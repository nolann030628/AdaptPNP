...
class Demo_Scene_Env(BaseEnv):
    def __init__(
        ...
        self.workdesk = Load_Scene(
            ...
            usd_path=os.path.join(self.root_path, "../Assets/Objects/desk_wall/desk_wall.usd"),
        ...
        self.transparent_material = Surface_Extend(prim_path=visual_prim_path, opacity=0.6)

        
        self.object = Load_Scene(
            position=np.array([0.14, 0, 0.8]),
            orientation=np.array([90.0, 0.0, -90]),
            scale=np.array([0.008, 0.004, 0.0082]),
            usd_path=os.path.join(self.root_path, "../Assets/Objects/keyboard/scene.usdc"),
        ...
        self.non_collision_object = Load_Scene(
            position=np.array([-0.14, 0, 0.75523]),
            orientation=np.array([90.0, 0.0, -90]),
            scale=np.array([0.008, 0.004, 0.0082]),
            usd_path=os.path.join(self.root_path, "../Assets/Objects/keyboard/scene.usdc"),
