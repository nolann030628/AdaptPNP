...
class Demo_Scene_Env(BaseEnv):
    def __init__(
        ...
        self.workdesk = Load_Scene(
            position=np.array([0.00, 0, 0.0]),
            orientation=np.array([0.0, 0.0, 0.0]),
            scale=np.array([0.55, 0.47, 0.63]),
            usd_path=os.path.join(self.root_path, "../Assets/Objects/desk_slope/desk_slope.usd"),
        ...
        self.object = Load_Scene(
            position=np.array([0.11, 0, 0.8]),
            orientation=np.array([-90.0, 0.0, 0]),
            scale=np.array([0.0055, 0.02, 0.0055]),
            usd_path=os.path.join(self.root_path, "../Assets/Objects/chocolate/chocolate.usd"),
        ...
        self.non_collision_object = Load_Scene(
            position=np.array([-0.14, 0, 0.7495]),
            orientation=np.array([-90.0, 0.0, 90]),
            scale=np.array([0.0055, 0.02, 0.0055]),
            usd_path=os.path.join(self.root_path, "../Assets/Objects/chocolate/chocolate_trans.usd"),
